...
namespace Unity.FPS.Gameplay
{
    ...
    public class PlayerWeaponsManager : MonoBehaviour
    {
        ...
        [Tooltip("Position for flashlight")]
        public Transform FlashlightPosition;

        [Tooltip("Flashlight light options")]
        ...
        void Update()
        {
            ...
            if(m_InputHandler.GetFlashlightDown())
            {
                if (Time.time - m_TimeFlashlightToggled > 0.2f)
                {
                    Flashlight.enabled = !Flashlight.enabled;
                    m_TimeFlashlightToggled = Time.time;
                }
            }
        }
        ...
        void UpdateWeaponAiming()
        {
            if (m_WeaponSwitchState == WeaponSwitchState.Up)
            {
                ...
                {
                    m_WeaponMainLocalPosition = Vector3.Lerp(m_WeaponMainLocalPosition,
                        DefaultWeaponPosition.localPosition + activeWeapon.IdleOffset, AimingAnimationSpeed * Time.deltaTime);
        ...
        void UpdateWeaponSwitching()
        {
            ...
            if (m_WeaponSwitchState == WeaponSwitchState.PutDownPrevious)
            {
                m_WeaponMainLocalPosition = Vector3.Lerp(DefaultWeaponPosition.localPosition + activeWeapon.IdleOffset,
            ...
            else if (m_WeaponSwitchState == WeaponSwitchState.PutUpNew)
            {
                m_WeaponMainLocalPosition = Vector3.Lerp(DownWeaponPosition.localPosition,
                    DefaultWeaponPosition.localPosition + activeWeapon.IdleOffset, switchingTimeFactor);
            }
        }
